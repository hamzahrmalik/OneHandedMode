...
public class NotificationTap extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int id = getIntent().getIntExtra(Keys.INTENT_DATA,
				pref.getInt(Keys.DEFAULT_TOGGLE, 2));
		toggle(id);
		if (pref.getBoolean(Keys.SHOW_TOGGLE_TOAST, true))
			Toast.makeText(this,
					"Toggled One-Hand Mode for " + toggle_names[id],
	...
	public void toggleApps() {
		@SuppressWarnings("deprecation")
		SharedPreferences pref = getSharedPreferences("apps",
				Context.MODE_WORLD_READABLE);
	...
	public void toggleNC() {
		@SuppressWarnings("deprecation")
		SharedPreferences pref = getSharedPreferences("NC",
				Context.MODE_WORLD_READABLE);
		Editor editor = pref.edit();
		editor.putBoolean(Keys.MASTER_SWITCH,
				!pref.getBoolean(Keys.MASTER_SWITCH, false));
		editor.apply();
	}
